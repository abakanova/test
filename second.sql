...
Select call_logs.Call_id,call_logs.Timestamp_start, call_logs.Timestamp_end, call_logs.Timestamp_end-call_logs.Timestamp_start as 'duration', call_logs.UID,accounts.name 
